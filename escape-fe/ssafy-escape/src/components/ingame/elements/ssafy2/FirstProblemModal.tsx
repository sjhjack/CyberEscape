      ...
      <div>
        ...
        <ChoiceBox1>
          <Button
            ...
            onClick={() =>
              handleAnswerCheck(
                optionData["ssafy2QuizList"][quizData[0].quizUuid][0],
              )
            }
          />
          <Button
            ...
            onClick={() =>
              handleAnswerCheck(
                optionData["ssafy2QuizList"][quizData[0].quizUuid][1],
              )
            }
          />
        </ChoiceBox1>
        <ChoiceBox2>
          <Button
            ...
            onClick={() =>
              handleAnswerCheck(
                optionData["ssafy2QuizList"][quizData[0].quizUuid][2],
              )
            }
          />
          <Button
            ...
            onClick={() =>
              handleAnswerCheck(
                optionData["ssafy2QuizList"][quizData[0].quizUuid][3],
              )
            }
          />
        </ChoiceBox2>
